...
nonisolated enum AgentJSON {
    ...
    /// to `.user`.
    static func decodeMessages(_ value: Any?) -> [ChatMessage] {
    ...
    static func unwrapResult(_ raw: String) -> String {
    ...
    static func jsLiteral(_ value: String) -> String { string(value) }
