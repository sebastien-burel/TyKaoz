...
enum ComfyUIError: Error, LocalizedError, Equatable {
...
struct ComfyUIClient {
    ...
    func systemStatsReachable() async -> Bool {
    ...
    static func discoverParameters(in json: String) -> [(name: String, default: String)] {
        var seen = Set<String>()
    ...
    func submit(graph: [String: Any], clientID: String) async throws -> String {
    ...
    static func parseSubmitResponse(_ data: Data) throws -> String {
    ...
    static func parseHistoryImage(_ data: Data, promptID: String) -> ImageRef? {
