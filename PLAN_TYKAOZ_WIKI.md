...
> **État au 2026-06-14 : phases 0→7 livrées et testées** (`Core/Wiki/`,
> `Persistence/Wiki/`, `UI/Wiki/`, outils `Tools/Wiki/`, suites de tests
> dédiées). Embeddings via **MLX** (bge-m3). Restent seulement les
> **extensions hors scope** ci-dessous (KG typé, reranker, moteur graphe
> dédié), non commencées et optionnelles.
